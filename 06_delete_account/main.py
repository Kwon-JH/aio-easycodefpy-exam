...
async def main():
    ...
    # 인증서 정보 가져오기
    cert = await encode_to_file_string('CERT_FILE_PATH')
    key = await encode_to_file_string('KEY_FILE_PATH')
    ...
    # 요청
    res = await codef.delete_account(ServiceType.SANDBOX, parameter)
    print(res)
